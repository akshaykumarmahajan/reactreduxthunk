...
const BasicForms = React.lazy(() => import('./views/forms/basicforms/BasicForms'));
const AdvancedForms = React.lazy(() => import('./views/forms/advancedforms/AdvancedForms'));
const ValidationForms = React.lazy(() => import('./views/forms/validationforms/ValidationForms'));

const Table = React.lazy(() => import('./views/tables/Tables/Tables'));
const DataTable = React.lazy(() => import('./views/tables/DataTable/DataTable'));
...
const routes = [
  ...
  { path: '/forms/basicforms', name: 'BasicForms', component: BasicForms },
  { path: '/forms/advancedforms', name: 'AdvancedForms', component: AdvancedForms },
  { path: '/forms/validationforms', name: 'ValidationForms', component: ValidationForms },
  { path: '/tables/table', name: 'Table', component: Table },
  { path: '/tables/datatable', name: 'DataTable', component: DataTable },
